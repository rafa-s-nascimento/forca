...
function validacaoLetras(event) {
  if (valido.parentElement.style.display == "flex") {
    if (validar(event)) {
      ...
      let temNoArray = verificaSeLetraJaFoiPrecionada(letra, letrasPrecionadas);
      ...
      if (!temNoArray) {
        ...
        if (verificaSeLetraEstaNaPalavra(letra)) {
          ...
          exibirLetrasCorretasNaTela(letra, indexDaLetraNaPalavraSorteada);
          checarVitoria();
        } else {
...
function at(num, word) {
  if (num == 1) {
    ...
    avisos.firstElementChild.querySelector(".vitoria").style.display = "flex";
    document.querySelector(".desistir").textContent = "Retornar";
  } else if (num == 2) {
    avisos.style.display = "flex";
    avisos.firstElementChild.style.backgroundColor = "red";
    avisos.firstElementChild.querySelector(".derrota").style.display = "flex";
    document.querySelector(".desistir").textContent = "Retornar";
  } else if (num == 3) {
    avisos.style.display = "flex";
    avisos.firstElementChild.style.backgroundColor = "magenta";
    avisos.firstElementChild.querySelector(".palavraAdd").style.color = "white";
    ...
    avisos.firstElementChild.querySelector(".palavraAdd").style.display =
      "none";
    avisos.firstElementChild.querySelector(".derrota").style.display = "none";
    avisos.firstElementChild.querySelector(".vitoria").style.display = "none";
  } else if (num == 5) {
    avisos.style.display = "flex";
    avisos.firstElementChild.style.backgroundColor = "red";
    avisos.firstElementChild.querySelector(
